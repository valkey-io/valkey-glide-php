...
/**
 * Integration tests for JSON.SET and JSON.GET commands.
 * Requires a Valkey/Redis server with the JSON module loaded.
 */
class ValkeyGlideJsonTest extends ValkeyGlideBaseTest
{
